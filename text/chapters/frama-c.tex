...
Přidání variantu cyklu do kódu~\ref{list:loop-with-variant}
a výsledek nové analýzy~\ref{list:loop-with-variant-output} indikují sedm úspěšně prokázaných vlastností.
...
\begin{listing}[H]
    ...
    Goal Preservation of Invariant (file loop-variant.c, line 6):
    Assume { ... }
    Prove: 0 <= n.
    Prover Qed returns Valid
    ...
    Goal Establishment of Invariant (file loop-variant.c, line 6):
    Assume { ... }
    Prove: 0 <= n.
    Prover Qed returns Valid
    ...
    Goal Assertion (file loop-variant.c, line 12):
    Assume { ... }
    Prove: n = 0.
    ...
    Goal Decreasing of Loop variant at loop (file loop-variant.c, line 9):
    Assume { ... }
    Prove: n < n_1.
    Prover Qed returns Valid
    ...
    Goal Positivity of Loop variant at loop (file loop-variant.c, line 9):
    Assume { ... }
    Prove: 0 <= n.
    Prover Qed returns Valid
    \end{minted}
