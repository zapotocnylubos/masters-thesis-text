...
Por účely dúkazů se bude hodit predikát \texttt{reachable},
...
Pomocí predikátu \texttt{reachable} je možné definovat vlastnost konečnosti (bezcykličnosti) spojového seznamu.
...
Frama\mbox{-}C nepodporuje plné využít dynamické alokace pomocí standardní knihovny jazyka C~\cite{C11Standard}.
